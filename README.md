# Cuis7-6
Cuis Smalltalk version 7.6 Stable Release
...
[Documentation](https://github.com/Cuis-Smalltalk/Cuis7-6/blob/master/Documentation/).

## Running Cuis

The easiest way to download and run Cuis is to clone this Git repository. Alternatively, you can download the [Zip file](https://github.com/Cuis-Smalltalk/Cuis7-6/archive/refs/heads/main.zip). Double click on it to unzip.
